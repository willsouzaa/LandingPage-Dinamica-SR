      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[100] grid place-items-center bg-black/88 p-3 backdrop-blur-md sm:p-6"
          >
            <div className="flex max-h-[90dvh] w-full max-w-6xl flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#090909] shadow-[0_30px_110px_rgba(0,0,0,0.55)]">
              {/* Header */}
            ...
            <AnimatePresence mode="wait">
              {active === null ? (
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
                    {images.map((img, index) => (
                      <motion.button
                        ...
                        className="group relative overflow-hidden rounded-xl bg-white/5 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)]"
                      >
                ...
                >
                  {/* Imagem principal */}
                  <div className="relative min-h-[280px] flex-1 bg-black sm:min-h-[460px]">
                    <SafeImage
                    ...
                    <button
                      ...
                      className="absolute left-3 top-1/2 -translate-y-1/2 grid size-11 place-items-center rounded-full border border-white/15 bg-black/50 text-white/80 backdrop-blur transition hover:border-white/40 hover:text-white sm:left-5"
                    >
                      <ChevronLeft size={20} />
                    </button>
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 grid size-11 place-items-center rounded-full border border-white/15 bg-black/50 text-white/80 backdrop-blur transition hover:border-white/40 hover:text-white sm:right-5"
                    >
